...
function optionsframework_page() {
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
			<a href="http://inspectelement.com/wordpress-themes/origin-responsive-magazineblog-wordpress-theme/" class="button-primary">Upgrade</a> 
			<div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options', 'kickstart' ),
